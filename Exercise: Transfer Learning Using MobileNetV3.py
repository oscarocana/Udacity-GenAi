...
for images, labels in testloader:
    ...
    images= images.to(device) # Moves images to the device
    label = labels.to(device) # Moves labels to the device
​
    # Forward pass
    outputs = model(images) # Get model outputs
    loss += loss_fn(outputs, labels).item() # Calculate loss and accumulate it
​
